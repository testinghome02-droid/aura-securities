...
const StickySocials = () => {
  return (
    <div className="fixed top-1/3 left-0 flex flex-col space-y-3 backdrop-blur-sm p-2 rounded-r-2xl shadow-xl z-50">
      {socials.map((social) => (
        <a
          key={social.name}
          href={social.href}
          ...
          className={`group flex h-11 w-11 items-center justify-center rounded-full border bg-gradient-to-br ${social.border} ${social.gradient} ${social.text} shadow-lg shadow-slate-900/60 transition hover:scale-110 hover:shadow-xl`}
        >
          {social.icon}
        </a>
      ))}
